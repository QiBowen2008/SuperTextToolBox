...
**20260708公告：由于最新的PaddleOCR识别准确率意外下降，暂时不会更新**
...
系统要求：推荐Windows7以上，OCR需要64位系统，XP系统不支持OCR和词云，Vista我没测试。推荐安装.Net Framework 4.7.2或更高版本以使用全部功能，XP请安装4.0

# 二、安装
对于win10和win11，请运行
winget install Buger.SuperTextToolBox
对于其他系统，先安装.NET Framework 4以上（建议4.8）在下载安装包并安装
# 三、功能介绍
